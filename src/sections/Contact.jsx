...
const contactInfo = [
    {
        icon: Mail,
        label: "Email",
        value: "nimafarzizad@gmail.com",
        href: "mailto:nimafarzizad@gmail.com",
    },
    {
        icon: Phone,
        label: "Phone",
        value: "0930 325 2864",
        href: "tel:09303252864",
    },
    {
        icon: MapPin,
        label: "Location",
...
const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const serviceId = import.meta.env.VITE_EMAILJS_SEVICE_ID;
            ...
            setSubmitStatus({
                type: "error",
                message:
                    error.text || "Fail to send message. Please try again later."
            })
    ...
    return (
        <section id="contact" className="py-32 relative overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-full">
                ...
                <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-highlight/5 blur-3xl"></div>
            </div>
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <p className="text-muted-foreground animate-fade-in animation-delay-100"></p>
                </div>
                    ...
                    <div className="space-y-6 animate-fade-in animation-delay-400">
                        ...
                        <div className="glass rounded-3xl p-8 border border-primary/30">
                            ...
                            <p className="text-muted-foreground text-sm">
                                ...
                                Whether youn need a full-time engineer or a freelance consultant,
                                lets talk!
                            </p>
                        </div>
                    </div>
